  ...
  useEffect(() => {
    fetch('/src/data/portfolioData.json')
      ...
      .then((data) => {
        ...
        setSectionTitle(data.sections.experience.title);
      });
  }, []);
            ...
            {experienceData.map((item, idx) => (
              <div key={idx} className="timeline-card">
                ...
                <div className="timeline-floating-icon">
                  <div className="timeline-icon-placeholder" style={{ background: `linear-gradient(135deg, var(--experience-color, #2196F3) 0%, var(--accent-secondary) 100%)` }}>
